...
3. Restaurar conjuntamente el artefacto `dist` y su `.htaccess`; no dejar reglas nuevas apuntando a páginas retiradas ni mezclar HTML y redirects de versiones distintas.
